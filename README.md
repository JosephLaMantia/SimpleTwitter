...
<img src="twitter-2.gif"/>

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Had trouble displaying remaining characters for new tweets.
...
Only issue encountered was rate limits for twitters API.
Also added timestamps, but making them relative was a challenge I hope to fix later.
